...
const buttonVariants = cva(
  'inline-flex items-center justify-center rounded-lg text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:ring-offset-2 disabled:opacity-50 disabled:pointer-events-none ring-offset-slate-900 active:scale-[0.98]',
  {
    variants: {
      variant: {
        default: 'bg-[#6D28D9] text-white hover:bg-[#7C3AED] shadow-lg shadow-indigo-900/20 border-0',
